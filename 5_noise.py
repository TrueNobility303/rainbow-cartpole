...
from net.noise import NoisyLinear

initial_seed(42)

#REF:https://github.com/Curt-Park/rainbow-is-all-you-need/

#Noisy DQN引入NoisyLayer，使得DQN的估计结果本身就带有噪声，从而取代了epsilon greedy策略
...
class DQNAgent:
    ...
    def update_model(self) -> torch.Tensor:
        ...
        # NoisyNet: reset noise 每次更新之后生成新的高斯噪声
    ...
    def train(self, num_frames: int, plotting_interval: int = 200):
        ...
        plt.savefig('results/5_noise.png')
        self.env.close()
...
# parameters
#在训练noisenet的时候去掉了epsilon greedy的策略，从而采用了更大的memory和batch
num_frames = 20000
memory_size = 10000
batch_size = 128
target_update = 150

...
from net.replay import NStepReplayBuffer
...
class DQNAgent:
    def __init__(
        ...
        self.env = env
        self.memory = NStepReplayBuffer(obs_dim, memory_size, batch_size,n_step=3,gamma=0.99)
    ...
    def train(self, num_frames: int, plotting_interval: int = 200):
        ...
        plt.savefig('results/7_nstep.png')
        self.env.close()
